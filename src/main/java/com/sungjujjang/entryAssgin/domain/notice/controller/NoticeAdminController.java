...
import com.sungjujjang.entryAssgin.domain.notice.dto.NoticeUpdateRequest;
...
public class NoticeAdminController {
    ...
    public ApiResponse<IdResponse<Long>> noticeUpdate(
        ...
        Long userId = Long.valueOf(authentication.getName());
        Long newNoticeId = noticeService.updateNotice(noticeUpdateRequest, userId, noticeId);
